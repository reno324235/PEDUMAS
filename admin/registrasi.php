...
<script src="https://cdn.jsdelivr.net/npm/sweetalert2@10/dist/sweetalert2.min.css"></script>
<div class="row">
	<div class="col s12 m9">
		<h4 class="white-text">Masyarakat</h4>
	</div>
		...
		while ($r = mysqli_fetch_assoc($query)) { ?>
			<tr>
				...
				<td>
					...
					<button class="red btn" onclick="konfirmasiHapus(<?php echo $r['nik'] ?>)">Hapus</button>
				</td>
				<script>
					function konfirmasiHapus(nik) {
						Swal.fire({
							...
							if (result.isConfirmed) {
								window.location.href = 'index.php?p=regis_hapus&nik=' + nik;
							}
						})
					}
				</script>
