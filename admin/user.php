	...
	<tbody>
		...
		while ($r = mysqli_fetch_assoc($tampil)) { ?>
			<tr>
				...
				<td>
					<a class="btn teal modal-trigger" href="#user_edit<?php echo $r['id_petugas'] ?>">Edit</a>
					<button class="red btn" onclick="confirmDelete(<?php echo $r['id_petugas'] ?>)">Hapus</button>
				</td>
							...
							function confirmDelete(id) {
								Swal.fire({
									...
									if (result.isConfirmed) {
										window.location.href = 'index.php?p=user_hapus&id_petugas=' + id;
									}
								})
							}
						</script>
